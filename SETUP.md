# Tab Constellation — Setup Guide 🌌

A complete, step-by-step guide to getting Tab Constellation running on your
own machine — from a fresh clone to seeing your browsing history as a 3D
constellation.
...
Five pieces, all on your local machine:
...
The two databases run in Docker; everything else runs natively and talks to
them over `localhost`.
...
- **A Chromium browser** — Google Chrome or Brave
